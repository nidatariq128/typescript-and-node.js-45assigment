...
let friendsNames =["Alizba","Mavra","Tooba","Faryal","Rabi"];
 let message="do you learn typescript";
  console.log("Heloo",friendsNames[0],message);
  console.log("Hello",friendsNames[1],message);
  console.log("Hello",friendsNames[2],message);
  console.log("Hello",friendsNames[3],message);
  console.log("Hello",friendsNames[4],message);
